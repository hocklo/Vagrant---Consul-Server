...
Vagrant.configure(2) do |config|
  ...
  # config.vm.network "forwarded_port", guest: 80, host: 8080
    ...
    config.vm.network :forwarded_port, guest: 8301, host: 8301
    config.vm.network :forwarded_port, guest: 8302, host: 8302
  ...
  #  config.vm.network :forwarded_port, guest: 32770, host: 32770
  #  config.vm.network :forwarded_port, guest: 80, host: 8080
  ...
  # SHELL
  #config.vm.provision "file", source: "./git2consul.json", destination: "~/config.json" 
